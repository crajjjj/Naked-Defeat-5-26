...
Scriptname nade_robbedquest_02_qf_scr Extends Quest Hidden
...
Debug.Trace("NAKED DEFEAT robberyquest_02 (Startup STAGE)")
;BEGIN CODE
;Startup Stage
;END CODE
EndFunction
...
Debug.Trace("NAKED DEFEAT robberyquest_02 (Start STAGE)")
;BEGIN CODE
;start stage
;cfgqst.Robbed = true
...
;BEGIN FRAGMENT Fragment_1				;STAGE 1000
Function Fragment_1()
Debug.Trace("NAKED DEFEAT robberyquest_02: Stage 1000 (completed)")
;BEGIN CODE
;shutdown stage
...
cfgqst.RobberyQuest02available()
;END CODE
EndFunction
;END FRAGMENT
...
Debug.Trace("NAKED DEFEAT robberyquest_02: Stage 200 (get stuff back)")
;BEGIN CODE
...
Function Fragment_8()
;BEGIN CODE
Debug.Trace("NAKED DEFEAT robberyquest_02: Stage 2000 (failed)")
;shutdown stage
