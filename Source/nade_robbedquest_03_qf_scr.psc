...
Scriptname nade_robbedquest_03_qf_scr Extends Quest Hidden
...
Debug.Trace("NAKED DEFEAT robberyquest_03 (Startup STAGE)")
;BEGIN CODE
;Startup Stage
;END CODE
EndFunction
...
Debug.Trace("NAKED DEFEAT robberyquest_03 (Start STAGE)")
;BEGIN CODE
;start stage
;cfgqst.Robbed = true
...
Function Fragment_1()
Debug.Trace("NAKED DEFEAT robberyquest_03: Stage 1000 (completed)")
;BEGIN CODE
;shutdown stage
...
cfgqst.RobberyQuest03available()
;END CODE
EndFunction
;END FRAGMENT
...
Debug.Trace("NAKED DEFEAT robberyquest_03: Stage 200 (get stuff back)")
;BEGIN CODE
...
Function Fragment_8()
;BEGIN CODE
Debug.Trace("NAKED DEFEAT robberyquest_03: Stage 2000 (failed)")
;shutdown stage
