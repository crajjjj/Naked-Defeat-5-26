...
endFunction
;=========================================================================================
; SexLab P+ compile-time interface additions (Naked Defeat crajjjj patch).
; This folder is used ONLY as a Papyrus import so NADE can compile calls to the P+ native
; registry API. It is never compiled or shipped - at runtime these calls bind to the real
; sslAnimationSlots.pex from SexLab P+. Signatures copied from P+ sslAnimationSlots.psc.
;=========================================================================================
