...
function RegisterRaces()
	...
	;Netches = Actors\DLC02\Netch\NetchProject.hkx
		...
		ClearRaceKey("NetchesCalf")
		AddRaceID("NetchesCalf", "DLC2NetchCalfRace")
...
;=========================================================================================
; SexLab P+ compile-time interface additions (Naked Defeat crajjjj patch). See sslAnimationSlots.psc.
;=========================================================================================
